...
@dataclass
class TailwindFlowbiteThemeType(Theme):
    """
    Tailwind CSS + Flowbite templates (``tailwind-flowbite`` folder).

    Usage::

        admin = Admin(app, theme=TailwindFlowbiteTheme())
    """

    folder: typing.Literal["tailwind-flowbite"]
    base_template: str = "admin/base.html"


TailwindFlowbiteTheme = partial(TailwindFlowbiteThemeType, folder="tailwind-flowbite")
